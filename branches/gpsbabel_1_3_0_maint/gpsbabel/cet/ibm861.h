...
#define cet_cs_name_ibm861 "IBM861"

const char *cet_cs_alias_ibm861[] = 
{
	"IBM861", "861", "CP861", "cp-is",
	NULL
};

#define cet_ucs4_ofs_ibm861 128
#define cet_ucs4_cnt_ibm861 128

const int cet_ucs4_map_ibm861[cet_ucs4_cnt_ibm861] =
{
...
#define cet_ucs4_to_ibm861_ct 127

const cet_ucs4_link_t cet_ucs4_to_ibm861_links[cet_ucs4_to_ibm861_ct] =
{
	 {0x00a0, 0xff} /* space */,
	 ...
	 {0x00c1, 0xa4} /* capital letter a with acute */,
	 ...
	 {0x00cd, 0xa5} /* capital letter i with acute */,
	 {0x00d0, 0x8b} /* capital letter eth (icelandic) */,
	 {0x00d2, 0x9f} /* capital letter o with grave */,
	 {0x00d3, 0xa6} /* capital letter o with acute */,
	 {0x00d6, 0x99} /* capital letter o with diaeresis */,
	 {0x00d8, 0x9d} /* capital letter o with stroke */,
	 {0x00da, 0xa7} /* capital letter u with acute */,
	 {0x00dc, 0x9a} /* capital letter u with diaeresis */,
	 {0x00dd, 0x97} /* capital letter y with acute */,
	 {0x00de, 0x8d} /* capital letter thorn (icelandic) */,
	 ...
	 {0x00fe, 0x95} /* small letter thorn (icelandic) */,
...
/*
#define cet_ucs4_to_ibm861_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm861_extra[cet_ucs4_to_ibm861_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm861 =	/* defined in cet.h */
{	
	cet_cs_name_ibm861,		/* name of character set	*/
	cet_cs_alias_ibm861,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm861,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm861,		/* first non standard character	*/
	cet_ucs4_cnt_ibm861,		/* number of values in table	*/

	cet_ucs4_to_ibm861_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm861_ct,		/* number of links		*/
...
/*
const int ibm861_ucs4_full_map[] =
{
