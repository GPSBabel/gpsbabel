...
#define cet_cs_name_ibm500 "IBM500"
...
#define cet_ucs4_ofs_ibm500 4
#define cet_ucs4_cnt_ibm500 252

const int cet_ucs4_map_ibm500[cet_ucs4_cnt_ibm500] =
{
...
#define cet_ucs4_to_ibm500_ct 236

const cet_ucs4_link_t cet_ucs4_to_ibm500_links[cet_ucs4_to_ibm500_ct] =
{
...
/*
#define cet_ucs4_to_ibm500_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm500_extra[cet_ucs4_to_ibm500_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm500 =	/* defined in cet.h */
{	
	cet_cs_name_ibm500,		/* name of character set	*/
	cet_cs_alias_ibm500,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm500,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm500,		/* first non standard character	*/
	cet_ucs4_cnt_ibm500,		/* number of values in table	*/

	cet_ucs4_to_ibm500_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm500_ct,		/* number of links		*/
...
/*
const int ibm500_ucs4_full_map[] =
{
