...
#define cet_cs_name_ibm903 "IBM903"

const char *cet_cs_alias_ibm903[] = 
{
	"IBM903/CR-LF", "903/CR-LF", "CP903/CR-LF", NULL
};
...
{	
	cet_cs_name_ibm903,		/* name of character set	*/
	cet_cs_alias_ibm903,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm903,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm903,		/* first non standard character	*/
	cet_ucs4_cnt_ibm903,		/* number of values in table	*/

	cet_ucs4_to_ibm903_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm903_ct,		/* number of links		*/
...
/*
const int ibm903_ucs4_full_map[] =
{
