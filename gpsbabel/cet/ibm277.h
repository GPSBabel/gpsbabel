...
#define cet_cs_name_ibm277 "IBM277"
...
#define cet_ucs4_cnt_ibm277 252

const int cet_ucs4_map_ibm277[cet_ucs4_cnt_ibm277] =
{
	...
	0x00e0, 0x00e1, 0x00e3, 0x007d, 0x00e7, 0x00f1, 0x0023, 0x002e, 
	...
	0x00c0, 0x00c1, 0x00c3, 0x0024, 0x00c7, 0x00d1, 0x00f8, 0x002c, 
	0x0025, 0x005f, 0x003e, 0x003f, 0x00a6, 0x00c9, 0x00ca, 0x00cb, 
	0x00c8, 0x00cd, 0x00ce, 0x00cf, 0x00cc, 0x0060, 0x003a, 0x00c6, 
	0x00d8, 0x0027, 0x003d, 0x0022, 0x0040, 0x0061, 0x0062, 0x0063, 
	...
	0x007b, 0x00b8, 0x005b, 0x005d, 0x00b5, 0x00fc, 0x0073, 0x0074, 
	...
	0x203e, 0x00a8, 0x00b4, 0x00d7, 0x00e6, 0x0041, 0x0042, 0x0043, 
	0x0044, 0x0045, 0x0046, 0x0047, 0x0048, 0x0049, 0x00ad, 0x00f4, 
	0x00f6, 0x00f2, 0x00f3, 0x00f5, 0x00e5, 0x004a, 0x004b, 0x004c, 
...
#define cet_ucs4_to_ibm277_ct 236

const cet_ucs4_link_t cet_ucs4_to_ibm277_links[cet_ucs4_to_ibm277_ct] =
{
	 ...
	 {0x00d7, 0xbf} /* sign */,
	 {0x00d8, 0x7c} /* capital letter o with stroke */,
	 ...
	 {0x00f7, 0xe1} /* sign */,
	 {0x00f8, 0x6a} /* small letter o with stroke */,
...
/*
#define cet_ucs4_to_ibm277_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm277_extra[cet_ucs4_to_ibm277_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm277 =	/* defined in cet.h */
{	
	cet_cs_name_ibm277,		/* name of character set	*/
	cet_cs_alias_ibm277,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm277,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm277,		/* first non standard character	*/
	cet_ucs4_cnt_ibm277,		/* number of values in table	*/

	cet_ucs4_to_ibm277_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm277_ct,		/* number of links		*/
...
/*
const int ibm277_ucs4_full_map[] =
{
