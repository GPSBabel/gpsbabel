...
#define cet_cs_name_it "IT"

const char *cet_cs_alias_it[] = 
{
	"IT", "ISO646-IT", "iso-ir-15", NULL
};

#define cet_ucs4_ofs_it 35
#define cet_ucs4_cnt_it 93

const int cet_ucs4_map_it[cet_ucs4_cnt_it] =
{
	...
	0x00b0, 0x00e7, 0x00e9, 0x005e, 0x005f, 0x00f9, 0x0061, 0x0062, 
	...
	0x00e0, 0x00f2, 0x00e8, 0x00ec, 0x007f
};

#define cet_ucs4_to_it_ct 10

const cet_ucs4_link_t cet_ucs4_to_it_links[cet_ucs4_to_it_ct] =
{
	 {0x00a3, 0x23} /* sign */,
	 {0x00a7, 0x40} /* sign */,
	 {0x00b0, 0x5b} /* sign */,
	 {0x00e0, 0x7b} /* small letter a with grave */,
	 {0x00e7, 0x5c} /* small letter c with cedilla */,
	 {0x00e8, 0x7d} /* small letter e with grave */,
	 {0x00e9, 0x5d} /* small letter e with acute */,
	 {0x00ec, 0x7e} /* small letter i with grave */,
	 {0x00f2, 0x7c} /* small letter o with grave */,
	 {0x00f9, 0x60} /* small letter u with grave */
};

/*
#define cet_ucs4_to_it_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_it_extra[cet_ucs4_to_it_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_it =	/* defined in cet.h */
{	
	cet_cs_name_it,		/* name of character set	*/
	cet_cs_alias_it,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_it,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_it,		/* first non standard character	*/
	cet_ucs4_cnt_it,		/* number of values in table	*/

	cet_ucs4_to_it_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_it_ct,		/* number of links		*/
