...
#define cet_cs_name_ibm863 "IBM863"
...
#define cet_ucs4_cnt_ibm863 128

const int cet_ucs4_map_ibm863[cet_ucs4_cnt_ibm863] =
{
...
#define cet_ucs4_to_ibm863_ct 128

const cet_ucs4_link_t cet_ucs4_to_ibm863_links[cet_ucs4_to_ibm863_ct] =
{
	 {0x00a0, 0xff} /* space */,
	 {0x00a2, 0x9b} /* sign */,
	 {0x00a3, 0x9c} /* sign */,
	 ...
	 {0x00be, 0xad} /* fraction three quarters */,
	 {0x00c0, 0x8e} /* capital letter a with grave */,
	 {0x00c2, 0x84} /* capital letter a with circumflex */,
	 {0x00c7, 0x80} /* capital letter c with cedilla */,
	 {0x00c8, 0x91} /* capital letter e with grave */,
	 {0x00c9, 0x90} /* capital letter e with acute */,
	 {0x00ca, 0x92} /* capital letter e with circumflex */,
	 {0x00cb, 0x94} /* capital letter e with diaeresis */,
	 {0x00ce, 0xa8} /* capital letter i with circumflex */,
	 {0x00cf, 0x95} /* capital letter i with diaeresis */,
	 {0x00d4, 0x99} /* capital letter o with circumflex */,
	 {0x00d9, 0x9d} /* capital letter u with grave */,
	 {0x00db, 0x9e} /* capital letter u with circumflex */,
...
/*
#define cet_ucs4_to_ibm863_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm863_extra[cet_ucs4_to_ibm863_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm863 =	/* defined in cet.h */
{	
	cet_cs_name_ibm863,		/* name of character set	*/
	cet_cs_alias_ibm863,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm863,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm863,		/* first non standard character	*/
	cet_ucs4_cnt_ibm863,		/* number of values in table	*/

	cet_ucs4_to_ibm863_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm863_ct,		/* number of links		*/
...
/*
const int ibm863_ucs4_full_map[] =
{
