...
#define cet_cs_name_ibm437 "IBM437"
...
#define cet_ucs4_cnt_ibm437 128

const int cet_ucs4_map_ibm437[cet_ucs4_cnt_ibm437] =
{
...
#define cet_ucs4_to_ibm437_ct 128

const cet_ucs4_link_t cet_ucs4_to_ibm437_links[cet_ucs4_to_ibm437_ct] =
{
	 {0x00a0, 0xff} /* space */,
...
/*
#define cet_ucs4_to_ibm437_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm437_extra[cet_ucs4_to_ibm437_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm437 =	/* defined in cet.h */
{	
	cet_cs_name_ibm437,		/* name of character set	*/
	cet_cs_alias_ibm437,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm437,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm437,		/* first non standard character	*/
	cet_ucs4_cnt_ibm437,		/* number of values in table	*/

	cet_ucs4_to_ibm437_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm437_ct,		/* number of links		*/
...
/*
const int ibm437_ucs4_full_map[] =
{
