                           ...
                           xcsv_parse_data* parse_data, const int line_no)
{
  ...
  case XcsvStyle::XT_LAT_HUMAN_READABLE:
    human_to_dec(value, &wpt->latitude, &wpt->longitude, HumanToDec::FindLatitude);
    break;
  ...
  case XcsvStyle::XT_LON_HUMAN_READABLE:
    human_to_dec(value, &wpt->latitude, &wpt->longitude, HumanToDec::FindLongitude);
    break;
  ...
  case XcsvStyle::XT_LATLON_HUMAN_READABLE:
    human_to_dec(value, &wpt->latitude, &wpt->longitude, HumanToDec::FindLatitudeAndLongitude);
    break;
  /* DIRECTIONS **********************************************************/
