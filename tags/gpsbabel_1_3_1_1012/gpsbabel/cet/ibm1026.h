...
#define cet_cs_name_ibm1026 "IBM1026"
...
#define cet_ucs4_cnt_ibm1026 252

const int cet_ucs4_map_ibm1026[cet_ucs4_cnt_ibm1026] =
{
	...
	0x00e6, 0x02db, 0x00c6, 0x00a4, 0x00b5, 0x00f6, 0x0073, 0x0074, 
	...
	0x2014, 0x00a8, 0x00b4, 0x00d7, 0x00e7, 0x0041, 0x0042, 0x0043, 
...
#define cet_ucs4_to_ibm1026_ct 236

const cet_ucs4_link_t cet_ucs4_to_ibm1026_links[cet_ucs4_to_ibm1026_ct] =
{
	 ...
	 {0x005b, 0x68} /* square bracket */,
	 {0x005c, 0xdc} /* solidus */,
	 {0x005d, 0xac} /* square bracket */,
	 {0x005e, 0x5f} /* accent */,
	 {0x005f, 0x6d} /* line */,
	 {0x0060, 0x8d} /* accent */,
	 ...
	 {0x007b, 0x48} /* curly bracket */,
	 {0x007c, 0xbb} /* line */,
	 {0x007d, 0x8c} /* curly bracket */,
	 {0x007e, 0xcc} /* tilde */,
	 {0x007f, 0x07} /* (del) */,
	 ...
	 {0x00c7, 0x4a} /* capital letter c with cedilla */,
	 ...
	 {0x00d6, 0x7b} /* capital letter o with diaeresis */,
	 {0x00d7, 0xbf} /* sign */,
	 ...
	 {0x00dc, 0x7f} /* capital letter u with diaeresis */,
	 ...
	 {0x00e7, 0xc0} /* small letter c with cedilla */,
	 ...
	 {0x00fc, 0xe0} /* small letter u with diaeresis */,
	 {0x00ff, 0xdf} /* small letter y with diaeresis */,
	 {0x011e, 0x5a} /* capital letter g with breve */,
	 {0x011f, 0xd0} /* small letter g with breve */,
	 {0x0130, 0x5b} /* capital letter i with dot above */,
	 {0x0131, 0x79} /* small letter i dotless */,
	 {0x015e, 0x7c} /* capital letter s with cedilla */,
...
/*
#define cet_ucs4_to_ibm1026_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm1026_extra[cet_ucs4_to_ibm1026_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm1026 =	/* defined in cet.h */
{	
	cet_cs_name_ibm1026,		/* name of character set	*/
	cet_cs_alias_ibm1026,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm1026,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm1026,		/* first non standard character	*/
	cet_ucs4_cnt_ibm1026,		/* number of values in table	*/

	cet_ucs4_to_ibm1026_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm1026_ct,		/* number of links		*/
...
/*
const int ibm1026_ucs4_full_map[] =
{
