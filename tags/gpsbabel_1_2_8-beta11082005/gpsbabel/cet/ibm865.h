...
#define cet_cs_name_ibm865 "IBM865"

const char *cet_cs_alias_ibm865[] = 
{
	"IBM865/CR-LF", "865/CR-LF", "CP865/CR-LF", NULL
};

#define cet_ucs4_ofs_ibm865 128
#define cet_ucs4_cnt_ibm865 128

const int cet_ucs4_map_ibm865[cet_ucs4_cnt_ibm865] =
{
...
#define cet_ucs4_to_ibm865_ct 128

const cet_ucs4_link_t cet_ucs4_to_ibm865_links[cet_ucs4_to_ibm865_ct] =
{
	 {0x00a0, 0xff} /* space */,
...
/*
#define cet_ucs4_to_ibm865_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm865_extra[cet_ucs4_to_ibm865_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm865 =	/* defined in cet.h */
{	
	cet_cs_name_ibm865,		/* name of character set	*/
	cet_cs_alias_ibm865,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm865,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm865,		/* first non standard character	*/
	cet_ucs4_cnt_ibm865,		/* number of values in table	*/

	cet_ucs4_to_ibm865_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm865_ct,		/* number of links		*/
...
/*
const int ibm865_ucs4_full_map[] =
{
