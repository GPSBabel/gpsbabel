...
#define cet_cs_name_keybcs2 "KEYBCS2"

const char *cet_cs_alias_keybcs2[] = 
{
	"KEYBCS2", "Kamenicky", NULL
};

#define cet_ucs4_ofs_keybcs2 128
#define cet_ucs4_cnt_keybcs2 128

const int cet_ucs4_map_keybcs2[cet_ucs4_cnt_keybcs2] =
{
...
#define cet_ucs4_to_keybcs2_ct 128

const cet_ucs4_link_t cet_ucs4_to_keybcs2_links[cet_ucs4_to_keybcs2_ct] =
{
	 {0x00a0, 0xff} /* space */,
	 {0x00a7, 0xad} /* sign */,
	 ...
	 {0x00cd, 0x8b} /* capital letter i with acute */,
	 {0x00d3, 0x95} /* capital letter o with acute */,
	 {0x00d4, 0xa7} /* capital letter o with circumflex */,
	 ...
	 {0x00dd, 0x9d} /* capital letter y with acute */,
	 ...
	 {0x00fd, 0x98} /* small letter y with acute */,
	 {0x010c, 0x80} /* capital letter c with caron */,
	 {0x010d, 0x87} /* small letter c with caron */,
	 {0x010e, 0x85} /* capital letter d with caron */,
	 {0x010f, 0x83} /* small letter d with caron */,
	 {0x011a, 0x89} /* capital letter e with caron */,
	 {0x011b, 0x88} /* small letter e with caron */,
	 {0x0139, 0x8a} /* capital letter l with acute */,
	 {0x013a, 0x8d} /* small letter l with acute */,
	 {0x013d, 0x9c} /* capital letter l with caron */,
	 {0x013e, 0x8c} /* small letter l with caron */,
	 {0x0147, 0xa5} /* capital letter n with caron */,
	 {0x0148, 0xa4} /* small letter n with caron */,
	 {0x0154, 0xab} /* capital letter r with acute */,
	 {0x0155, 0xaa} /* small letter r with acute */,
	 {0x0158, 0x9e} /* capital letter r with caron */,
	 {0x0159, 0xa9} /* small letter r with caron */,
	 {0x0160, 0x9b} /* capital letter s with caron */,
	 {0x0161, 0xa8} /* small letter s with caron */,
	 {0x0164, 0x86} /* capital letter t with caron */,
	 {0x0165, 0x9f} /* small letter t with caron */,
	 {0x016e, 0xa6} /* capital letter u with ring above */,
	 {0x016f, 0x96} /* small letter u with ring above */,
	 {0x017d, 0x92} /* capital letter z with caron */,
	 {0x017e, 0x91} /* small letter z with caron */,
...
/*
#define cet_ucs4_to_keybcs2_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_keybcs2_extra[cet_ucs4_to_keybcs2_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_keybcs2 =	/* defined in cet.h */
{	
	cet_cs_name_keybcs2,		/* name of character set	*/
	cet_cs_alias_keybcs2,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_keybcs2,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_keybcs2,		/* first non standard character	*/
	cet_ucs4_cnt_keybcs2,		/* number of values in table	*/

	cet_ucs4_to_keybcs2_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_keybcs2_ct,		/* number of links		*/
...
/*
const int keybcs2_ucs4_full_map[] =
{
