...
#define cet_cs_name_ibm862 "IBM862"

const char *cet_cs_alias_ibm862[] = 
{
	"IBM862/CR-LF", "862/CR-LF", "CP862/CR-LF", NULL
};

#define cet_ucs4_ofs_ibm862 128
#define cet_ucs4_cnt_ibm862 128

const int cet_ucs4_map_ibm862[cet_ucs4_cnt_ibm862] =
{
	...
	0x00bf,     -1, 0x00ac, 0x00bd, 0x00bc, 0x00a1, 0x00ab, 0x00bb, 
...
#define cet_ucs4_to_ibm862_ct 127

const cet_ucs4_link_t cet_ucs4_to_ibm862_links[cet_ucs4_to_ibm862_ct] =
{
	 {0x00a0, 0xff} /* space */,
	 ...
	 {0x05d0, 0x80} /* letter alef */,
	 {0x05d1, 0x81} /* letter bet */,
	 {0x05d2, 0x82} /* letter gimel */,
	 {0x05d3, 0x83} /* letter dalet */,
	 {0x05d4, 0x84} /* letter he */,
	 {0x05d5, 0x85} /* letter vav */,
	 {0x05d6, 0x86} /* letter zayin */,
	 {0x05d7, 0x87} /* letter het */,
	 {0x05d8, 0x88} /* letter tet */,
	 {0x05d9, 0x89} /* letter yod */,
	 {0x05da, 0x8a} /* letter final kaf */,
	 {0x05db, 0x8b} /* letter kaf */,
	 {0x05dc, 0x8c} /* letter lamed */,
	 {0x05dd, 0x8d} /* letter final mem */,
	 {0x05de, 0x8e} /* letter mem */,
	 {0x05df, 0x8f} /* letter final nun */,
	 {0x05e0, 0x90} /* letter nun */,
	 {0x05e1, 0x91} /* letter samekh */,
	 {0x05e2, 0x92} /* letter ayin */,
	 {0x05e3, 0x93} /* letter final pe */,
	 {0x05e4, 0x94} /* letter pe */,
	 {0x05e5, 0x95} /* letter final tsadi */,
	 {0x05e6, 0x96} /* letter tsadi */,
	 {0x05e7, 0x97} /* letter qof */,
	 {0x05e8, 0x98} /* letter resh */,
	 {0x05e9, 0x99} /* letter shin */,
	 {0x05ea, 0x9a} /* letter tav */,
	 {0x2022, 0xfa} /* puce */,
...
/*
#define cet_ucs4_to_ibm862_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm862_extra[cet_ucs4_to_ibm862_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm862 =	/* defined in cet.h */
{	
	cet_cs_name_ibm862,		/* name of character set	*/
	cet_cs_alias_ibm862,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm862,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm862,		/* first non standard character	*/
	cet_ucs4_cnt_ibm862,		/* number of values in table	*/

	cet_ucs4_to_ibm862_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm862_ct,		/* number of links		*/
...
/*
const int ibm862_ucs4_full_map[] =
{
