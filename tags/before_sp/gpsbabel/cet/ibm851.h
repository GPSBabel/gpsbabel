...
#define cet_cs_name_ibm851 "IBM851"

const char *cet_cs_alias_ibm851[] = 
{
	"IBM851/CR-LF", "851/CR-LF", "CP851/CR-LF", NULL
};

#define cet_ucs4_ofs_ibm851 128
#define cet_ucs4_cnt_ibm851 128

const int cet_ucs4_map_ibm851[cet_ucs4_cnt_ibm851] =
{
	0x00c7, 0x00fc, 0x00e9, 0x00e2, 0x00e4, 0x00e0, 0x0386, 0x00e7, 
	0x00ea, 0x00eb, 0x00e8, 0x00ef, 0x00ee, 0x0388, 0x00c4, 0x0389, 
	0x038a,     -1, 0x038c, 0x00f4, 0x00f6, 0x038e, 0x00fb, 0x00f9, 
	...
	0x039c, 0x2563, 0x2551, 0x2557, 0x255d, 0x039e, 0x039f, 0x2510, 
...
#define cet_ucs4_to_ibm851_ct 127

const cet_ucs4_link_t cet_ucs4_to_ibm851_links[cet_ucs4_to_ibm851_ct] =
{
	 {0x00a0, 0xff} /* space */,
	 {0x00a3, 0x9c} /* sign */,
	 {0x00a7, 0xf5} /* sign */,
	 ...
	 {0x039c, 0xb8} /* capital letter mu */,
	 {0x039d, 0xb7} /* capital letter nu */,
...
/*
#define cet_ucs4_to_ibm851_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm851_extra[cet_ucs4_to_ibm851_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm851 =	/* defined in cet.h */
{	
	cet_cs_name_ibm851,		/* name of character set	*/
	cet_cs_alias_ibm851,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm851,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm851,		/* first non standard character	*/
	cet_ucs4_cnt_ibm851,		/* number of values in table	*/

	cet_ucs4_to_ibm851_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm851_ct,		/* number of links		*/
...
/*
const int ibm851_ucs4_full_map[] =
{
