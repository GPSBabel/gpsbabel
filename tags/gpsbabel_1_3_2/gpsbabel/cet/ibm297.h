...
#define cet_cs_name_ibm297 "IBM297"

const char *cet_cs_alias_ibm297[] = 
{
	"IBM297", "297", "CP297", "ebcdic-cp-fr",
	NULL
};

#define cet_ucs4_ofs_ibm297 4
#define cet_ucs4_cnt_ibm297 252

const int cet_ucs4_map_ibm297[cet_ucs4_cnt_ibm297] =
{
	...
	0x0040, 0x00e1, 0x00e3, 0x00e5, 0x005c, 0x00f1, 0x00b0, 0x002e, 
	0x003c, 0x0028, 0x002b, 0x0021, 0x0026, 0x007b, 0x00ea, 0x00eb, 
	0x007d, 0x00ed, 0x00ee, 0x00ef, 0x00ec, 0x00df, 0x00a7, 0x0024, 
	0x002a, 0x0029, 0x003b, 0x005e, 0x002d, 0x002f, 0x00c2, 0x00c4, 
	0x00c0, 0x00c1, 0x00c3, 0x00c5, 0x00c7, 0x00d1, 0x00f9, 0x002c, 
	0x0025, 0x005f, 0x003e, 0x003f, 0x00f8, 0x00c9, 0x00ca, 0x00cb, 
	0x00c8, 0x00cd, 0x00ce, 0x00cf, 0x00cc, 0x00b5, 0x003a, 0x00a3, 
	0x00e0, 0x0027, 0x003d, 0x0022, 0x00d8, 0x0061, 0x0062, 0x0063, 
	...
	0x00e6, 0x00b8, 0x00c6, 0x00a4, 0x0060, 0x00a8, 0x0073, 0x0074, 
	0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a1, 0x00bf, 
	0x00d0, 0x00dd, 0x00de, 0x00ae, 0x00a2, 0x0023, 0x00a5, 0x00b7, 
	0x00a9, 0x005d, 0x00b6, 0x00bc, 0x00bd, 0x00be, 0x00ac, 0x007c, 
	0x203e, 0x007e, 0x00b4, 0x00d7, 0x00e9, 0x0041, 0x0042, 0x0043, 
	0x0044, 0x0045, 0x0046, 0x0047, 0x0048, 0x0049, 0x00ad, 0x00f4, 
	0x00f6, 0x00f2, 0x00f3, 0x00f5, 0x00e8, 0x004a, 0x004b, 0x004c, 
	0x004d, 0x004e, 0x004f, 0x0050, 0x0051, 0x0052, 0x00b9, 0x00fb, 
	0x00fc, 0x00a6, 0x00fa, 0x00ff, 0x00e7, 0x00f7, 0x0053, 0x0054, 
...
#define cet_ucs4_to_ibm297_ct 236

const cet_ucs4_link_t cet_ucs4_to_ibm297_links[cet_ucs4_to_ibm297_ct] =
{
	 ...
	 {0x00e0, 0x7c} /* small letter a with grave */,
	 ...
	 {0x00e9, 0xc0} /* small letter e with acute */,
	 ...
	 {0x00f9, 0x6a} /* small letter u with grave */,
...
/*
#define cet_ucs4_to_ibm297_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_ibm297_extra[cet_ucs4_to_ibm297_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_ibm297 =	/* defined in cet.h */
{	
	cet_cs_name_ibm297,		/* name of character set	*/
	cet_cs_alias_ibm297,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_ibm297,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_ibm297,		/* first non standard character	*/
	cet_ucs4_cnt_ibm297,		/* number of values in table	*/

	cet_ucs4_to_ibm297_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_ibm297_ct,		/* number of links		*/
...
/*
const int ibm297_ucs4_full_map[] =
{
