...
#define cet_cs_name_bs_4730 "BS_4730"

const char *cet_cs_alias_bs_4730[] = 
{
	"BS_4730", "gb", "ISO646-GB", "iso-ir-4", 
	"uk", NULL
};

#define cet_ucs4_ofs_bs_4730 35
#define cet_ucs4_cnt_bs_4730 93

const int cet_ucs4_map_bs_4730[cet_ucs4_cnt_bs_4730] =
{
	...
	0x007b, 0x007c, 0x007d, 0x203e, 0x007f
};

#define cet_ucs4_to_bs_4730_ct 2

const cet_ucs4_link_t cet_ucs4_to_bs_4730_links[cet_ucs4_to_bs_4730_ct] =
{
	 {0x00a3, 0x23} /* sign */,
...
/*
#define cet_ucs4_to_bs_4730_extra_ct 0
const cet_ucs4_link_t cet_ucs4_to_bs_4730_extra[cet_ucs4_to_bs_4730_extra_ct] = {};
*/

cet_cs_vec_t cet_cs_vec_bs_4730 =	/* defined in cet.h */
{	
	cet_cs_name_bs_4730,		/* name of character set	*/
	cet_cs_alias_bs_4730,		/* alias table			*/

	NULL,				/* ... to UCS-4 converter (multi-byte) */
	NULL,				/* UCS-4 to ... converter (multi-byte) */

	cet_ucs4_map_bs_4730,		/* char to UCS-4 value table	*/
	cet_ucs4_ofs_bs_4730,		/* first non standard character	*/
	cet_ucs4_cnt_bs_4730,		/* number of values in table	*/

	cet_ucs4_to_bs_4730_links,	/* UCS-4 to char links		*/
	cet_ucs4_to_bs_4730_ct,		/* number of links		*/
...
/*
const int bs_4730_ucs4_full_map[] =
{
