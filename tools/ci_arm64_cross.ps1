...
& "$installationPath\Common7\Tools\Launch-VsDevShell.ps1" -Arch arm64 -HostArch amd64 -SkipAutomaticLocation
...
$toolchain_file = "$qt_root_dir/msvc2022_arm64/lib/cmake/Qt6/qt.toolchain.cmake"
$qt_host_path = "$qt_root_dir/msvc2022_64"
