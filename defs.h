...
QString convert_human_date_format(const char* human_datef, bool read);	/* "MM,YYYY,DD" -> "%m,%Y,%d" */
QString convert_human_time_format(const char* human_timef, bool read);	/* "HH+mm+ss"   -> "%H+%M+%S" */
